...
def generate_letter_positions(letter='A', n_agents=10000000, width=1000, height=1000, thickness=10):
    agents = []
...
np.savetxt("../datasets/s2_generated_Ashape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='B', n_agents=10000)
np.savetxt("../datasets/s2_generated_Bshape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='C', n_agents=10000)
np.savetxt("../datasets/s2_generated_Cshape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='D', n_agents=10000)
np.savetxt("../datasets/s2_generated_Dshape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='E', n_agents=10000)
np.savetxt("../datasets/s2_generated_Eshape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='F', n_agents=10000)
np.savetxt("../datasets/s2_generated_Fshape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='G', n_agents=10000)
np.savetxt("../datasets/s2_generated_Gshape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='H', n_agents=10000)
np.savetxt("../datasets/s2_generated_Hshape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='I', n_agents=10000)
np.savetxt("../datasets/s2_generated_Ishape.txt", positions.astype(int), fmt="%6d")
positions = generate_letter_positions(letter='J', n_agents=10000)
np.savetxt("../datasets/s2_generated_Jshape.txt", positions.astype(int), fmt="%6d")
